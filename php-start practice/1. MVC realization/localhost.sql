...
-- Database: `mvc_site`
--
CREATE DATABASE IF NOT EXISTS `mvc_site` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `mvc_site`;
...
('root', '[{"db":"mvc_site","table":"news"},{"db":"mvc_site","table":"publication"},{"db":"polymorphism","table":"publication"}]');
...
('root', '2018-12-02 09:06:18', '{"collation_connection":"utf8mb4_unicode_ci"}');
